...
2. add the new folder at the root of the project with name "datasets". inside datasets folder add the folders respectively with name: "live_tracking_datasets" and "flights". both folders will have the csv files downloaded from the above mentioned link.
